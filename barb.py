...
# sample command:
# python streamlining4.py -D surveys/*.json -c <number of cpus> -s <name of npz file>
...
# converts the arrays to numpy arrays
...
# this returns a uniform random distribution mimicking the distribution of the data
plt.hist(p0[:, 0])
