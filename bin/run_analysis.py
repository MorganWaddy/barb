...
from mcmc import sampling, convert_params, read_samples
...
old_tau, sampler = sampling(p0, varrgroup, cpu_num, nwalkers, ndim, max_n)

samples = read_samples(h5name)
converted_params = convert_params(samples)
make_corner(converted_params, save = True, cornername)
